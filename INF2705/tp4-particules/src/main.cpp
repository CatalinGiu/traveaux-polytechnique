...
// - Catalin Giurca (1788129)
// - Dominique Deschenes (1800178)
...
void calculerPhysique( )
{
   if ( enmouvement )
   {
	   ...
	   glUniform3f( locbDimRetroaction, bDim[0], bDim[1], bDim[2] );
	   glUniform3f( locpositionPuitsRetroaction, positionPuits[0], positionPuits[1], positionPuits[2] );
