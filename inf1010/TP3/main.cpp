...
Description: Classe centrale du programme cherchant a implementer une bibliotheque avec tous les systemes s'y
             rattachant (emprunt, retour, creation d'abonnes, etc.)
*/
...
int main()
{
	...
	*livre6 = *livre1;
	...
	// Ne devrait pas marcher car l'abonne n'a jamais fait ce pret
