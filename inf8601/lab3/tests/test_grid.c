...
void test_grid_simple()
{
	...
	grid_sum(g2, &exp);
	grid_sum(g1, &act);
	assert_range(7.0, g2->data[0], "test_grid_copy2_1");
	assert_range(28.0, g2->data[15], "test_grid_copy2_2");
	free_grid(g1);
	free_grid(g2);
	...
	grid_sum(g2, &act);
	assert_range(62.0, g2->data[0], "test_grid_copy_block_1");
	assert_range(95.0, g2->data[15], "test_grid_copy_block_2");
	free_grid(g1);
	free_grid(g2);
