...
-- File : flx_longlong.h
--
-- Contents : Long long integer application layer for the FLX processor.
--
...
namespace flx_primitive {
    promotion void lmuluu(unsigned,unsigned,unsigned&,unsigned&)
