...
// All rights reserved.
// checkers -B -M -cflx_ia.ccf flx

// Processor: flx

#ifndef __Mdl_flx_iapcu_user_c__
#define __Mdl_flx_iapcu_user_c__
...
inline void flx_user_next_pc(flx* mdl, unsigned next_pc, unsigned nw, Checkers_next_pc_type npt)
{
    /* User code here */
    mdl->PC = next_pc;
}
